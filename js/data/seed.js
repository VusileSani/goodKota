...
export const seed = {
  ...
  merchants: [
    {
      id: "m1", name: "Kasi Bites Midrand", area: "Halfway House, Midrand", distanceKm: 1.4,
      ...
      menu: [
        { id: "p1", name: "Classic Kota", price: 4800, desc: "Chips, polony, cheese, atchar and house sauce.", available: true },
        { id: "p2", name: "Loaded Kota", price: 7600, desc: "Chips, russian, egg, bacon, cheese and sauce.", available: true },
        { id: "p3", name: "Chicken Kota", price: 8200, desc: "Crispy chicken, chips, cheese, slaw and chilli mayo.", available: true }
      ]
    },
    {
      id: "m2", name: "Tembisa Kota House", area: "Ivory Park, Tembisa", distanceKm: 6.7,
      ...
      menu: [
        { id: "p4", name: "Tembisa Special", price: 6900, desc: "Chips, russian, vienna, egg, cheese and atchar.", available: true },
        { id: "p5", name: "Double Trouble", price: 8400, desc: "Double protein, chips, cheese, egg and atchar.", available: true },
        { id: "p6", name: "Budget Kota", price: 4200, desc: "Chips, polony, atchar and sauce.", available: true }
      ]
    },
    {
      id: "m3", name: "Centurion Kota Works", area: "The Reeds, Centurion", distanceKm: 10.9,
      ...
      menu: [
        { id: "p7", name: "Centurion Crunch", price: 7200, desc: "Crunchy chicken strips, chips, cheese and sauce.", available: true },
        { id: "p8", name: "Works Kota", price: 9400, desc: "Beef patty, russian, egg, cheese, chips and relish.", available: true }
      ]
    },
    {
      id: "m4", name: "Ebony Park Corner", area: "Ebony Park, Midrand", distanceKm: 3.8,
      ...
      menu: [
        { id: "p9", name: "Corner Classic", price: 4500, desc: "Chips, polony, cheese and atchar.", available: true },
        { id: "p10", name: "Corner Loaded", price: 7500, desc: "Russian, egg, cheese, chips and sauce.", available: true }
      ]
    }
  ],
  favourites: ["m2"],
  orders: [
    { id: "GK-1042", merchantId: "m1", customer: "Sani", status: "ready", total: 7600, items: [{ productId: "p2", qty: 1 }], createdAt: "Today · 12:18" },
    { id: "GK-1038", merchantId: "m2", customer: "Sani", status: "completed", total: 6900, items: [{ productId: "p4", qty: 1 }], createdAt: "8 Sep · 18:42" }
  ],
  candidates: [
  ...
  metrics: {
    repeatFinderRate: 38,
    repeatFinderPrevious: 31,
    qualifiedUsers30d: 1248,
    verifiedOutlets: 3,
    pendingReview: 2,
    merchantOpens7d: 3921
  }
};
