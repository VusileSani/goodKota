...
function openMerchantApplication(app, id, actor) {
  ...
  app.dialog.querySelector("#holdMerchantApplication")?.addEventListener("click", () => { app.commands.adminUpdateApplication("merchant", id, { status: "review", note: "Application retained for review" }, actor); app.closeDialog(); app.toast("The merchant application has been moved to review.", { title: "Application status saved" }); app.render(); });
  app.dialog.querySelector("#declineMerchantApplication")?.addEventListener("click", () => { app.commands.adminUpdateApplication("merchant", id, { status: "declined", note: "Application declined" }, actor); app.closeDialog(); app.toast("The merchant application has been declined.", { title: "Application status saved" }); app.render(); });
}
...
function openDriverApplication(app, id, actor) {
  ...
  app.dialog.querySelector("#holdDriverApplication")?.addEventListener("click", () => { app.commands.adminUpdateApplication("driver", id, { status: "review", note: "Application retained for review" }, actor); app.closeDialog(); app.toast("The driver application has been moved to review.", { title: "Application status saved" }); app.render(); });
  app.dialog.querySelector("#declineDriverApplication")?.addEventListener("click", () => { app.commands.adminUpdateApplication("driver", id, { status: "declined", note: "Application declined" }, actor); app.closeDialog(); app.toast("The driver application has been declined.", { title: "Application status saved" }); app.render(); });
}
