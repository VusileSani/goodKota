...
test("package/config/index files identify v6.11.0 and parse cleanly", () => {
  const pkg = JSON.parse(read("package.json"));
  assert.equal(pkg.version, "6.11.0");
  assert.equal(pkg.name, "yagoya-v6-11-navigation-app-choice");
